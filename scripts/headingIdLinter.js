 ...
 * pnpm lint-heading-ids --fix --> Fixes all markdown file's heading IDs
 * pnpm lint-heading-ids path/to/markdown.md --> Checks that particular file for missing heading ID (path can denote a directory or particular file)
 * pnpm lint-heading-ids --fix path/to/markdown.md --> Fixes that particular file's markdown IDs (path can denote a directory or particular file)
 */
